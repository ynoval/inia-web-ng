...
@Component({
  selector: 'app-police-sectional-ppna-annual-chart',
  templateUrl: './police-sectional-ppna-annual-chart.component.html',
  styleUrls: ['./police-sectional-ppna-annual-chart.component.scss'],
})
export class PoliceSectionalPPNAAnnualChartComponent {
