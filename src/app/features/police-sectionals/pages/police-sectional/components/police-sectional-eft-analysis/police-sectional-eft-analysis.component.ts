...
@Component({
  selector: 'app-police-sectional-eft-analysis',
  templateUrl: './police-sectional-eft-analysis.component.html',
  styleUrls: ['./police-sectional-eft-analysis.component.scss'],
})

export class PoliceSectionalEFTAnalysisComponent implements OnInit {
