...
@Component({
  selector: 'app-police-sectional-ppna-historical-chart',
  templateUrl: './police-sectional-ppna-historical-chart.component.html',
  styleUrls: ['./police-sectional-ppna-historical-chart.component.scss'],
})
export class PoliceSectionalPPNAHistoricalChartComponent {
