...
@Component({
  selector: 'app-police-sectional-ahppn-analysis',
  templateUrl: './police-sectional-ahppn-analysis.component.html',
  styleUrls: ['./police-sectional-ahppn-analysis.component.scss'],
})
export class PoliceSectionalAHPPNAnalysisComponent implements OnInit {
