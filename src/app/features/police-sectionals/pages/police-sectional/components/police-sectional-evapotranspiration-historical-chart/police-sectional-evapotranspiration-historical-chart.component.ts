...
@Component({
  selector: 'app-police-sectional-et-historical-chart',
  templateUrl: './police-sectional-evapotranspiration-historical-chart.component.html',
  styleUrls: ['./police-sectional-evapotranspiration-historical-chart.component.scss'],
})
export class PoliceSectionalEvapotranspirationHistoricalChartComponent {
