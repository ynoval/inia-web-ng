...
@Component({
  selector: 'app-police-sectional-apar-annual-chart',
  templateUrl: './police-sectional-apar-annual-chart.component.html',
  styleUrls: ['./police-sectional-apar-annual-chart.component.scss'],
})
export class PoliceSectionalAPARAnnualChartComponent {
