...
@Component({
  ...
  templateUrl: './police-sectional-hydrological-performance-annual-chart.component.html',
  styleUrls: ['./police-sectional-hydrological-performance-annual-chart.component.scss'],
})
