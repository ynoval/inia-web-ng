...
@Component({
  selector: 'app-police-sectional-et-annual-chart',
  templateUrl: './police-sectional-evapotranspiration-annual-chart.component.html',
  styleUrls: ['./police-sectional-evapotranspiration-annual-chart.component.scss'],
})
export class PoliceSectionalEvapotranspirationAnnualChartComponent {
