...
@Component({
  selector: 'app-police-sectional-area-info',
  templateUrl: './police-sectional-area-distribution.component.html',
  styleUrls: ['./police-sectional-area-distribution.component.scss'],
})
export class PoliceSectionalAreaDistributionComponent implements OnInit {
