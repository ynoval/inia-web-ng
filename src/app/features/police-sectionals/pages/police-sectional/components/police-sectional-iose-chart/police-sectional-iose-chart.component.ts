...
@Component({
  ...
  templateUrl: './police-sectional-iose-chart.component.html',
  styleUrls: ['./police-sectional-iose-chart.component.scss'],
})
export class PoliceSectionalIOSEChartComponent {
