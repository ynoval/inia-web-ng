...
@Component({
  selector: 'app-police-sectional-apar-historical-chart',
  templateUrl: './police-sectional-apar-historical-chart.component.html',
  styleUrls: ['./police-sectional-apar-historical-chart.component.scss'],
})
export class PoliceSectionalAPARHistoricalChartComponent {
