...
@Component({
  selector: 'app-padron-rh-historical-chart',
  templateUrl: './padron-hydrological-performance-historical-chart.component.html',
  styleUrls: ['./padron-hydrological-performance-historical-chart.component.scss'],
})
export class PadronHydrologicalPerformanceHistoricalChartComponent {
