...
@Component({
  selector: 'app-padron-ahppn-analysis',
  templateUrl: './padron-ahppn-analysis.component.html',
  styleUrls: ['./padron-ahppn-analysis.component.scss'],
})
export class PadronAHPPNAnalysisComponent implements OnInit {
