...
@Component({
  selector: 'app-padron-soil-analysis',
  templateUrl: './padron-soil-analysis.component.html',
  styleUrls: ['./padron-soil-analysis.component.scss'],
})
export class PadronSOILAnalysisComponent implements OnInit {
