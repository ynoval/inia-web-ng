...
@Component({
  selector: 'app-padron-et-historical-chart',
  templateUrl: './padron-evapotranspiration-historical-chart.component.html',
  styleUrls: ['./padron-evapotranspiration-historical-chart.component.scss'],
})
export class PadronEvapotranspirationHistoricalChartComponent {
