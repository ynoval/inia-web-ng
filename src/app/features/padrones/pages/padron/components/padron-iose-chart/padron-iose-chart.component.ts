...
@Component({
  selector: 'app-padron-iose-chart',
  templateUrl: './padron-iose-chart.component.html',
  styleUrls: ['./padron-iose-chart.component.scss'],
})
export class PadronIOSEChartComponent {
