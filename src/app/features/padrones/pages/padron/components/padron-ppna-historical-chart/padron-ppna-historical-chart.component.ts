...
@Component({
  selector: 'app-padron-ppna-historical-chart',
  templateUrl: './padron-ppna-historical-chart.component.html',
  styleUrls: ['./padron-ppna-historical-chart.component.scss'],
})
export class PadronPPNAHistoricalChartComponent {
