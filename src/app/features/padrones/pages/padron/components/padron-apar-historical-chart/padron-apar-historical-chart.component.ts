...
@Component({
  ...
  templateUrl: './padron-apar-historical-chart.component.html',
  styleUrls: ['./padron-apar-historical-chart.component.scss'],
})
export class PadronAPARHistoricalChartComponent {
