...
@Component({
  selector: 'app-padron-ppna-annual-chart',
  templateUrl: './padron-ppna-annual-chart.component.html',
  styleUrls: ['./padron-ppna-annual-chart.component.scss'],
})
export class PadronPPNAAnnualChartComponent {
