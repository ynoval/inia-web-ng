...
@Component({
  selector: 'app-padron-rh-annual-chart',
  templateUrl: './padron-hydrological-performance-annual-chart.component.html',
  styleUrls: ['./padron-hydrological-performance-annual-chart.component.scss'],
})
export class PadronHydrologicalPerformanceAnnualChartComponent {
