...
@Component({
  selector: 'app-padron-apar-annual-chart',
  templateUrl: './padron-apar-annual-chart.component.html',
  styleUrls: ['./padron-apar-annual-chart.component.scss'],
})
export class PadronAPARAnnualChartComponent {
