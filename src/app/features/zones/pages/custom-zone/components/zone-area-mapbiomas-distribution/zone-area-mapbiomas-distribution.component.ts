...
@Component({
  selector: 'app-zone-area-mapbiomas-info',
  templateUrl: './zone-area-mapbiomas-distribution.component.html',
  styleUrls: ['./zone-area-mapbiomas-distribution.component.scss'],
})
export class ZoneAreaMapbiomasDistributionComponent implements OnInit {
