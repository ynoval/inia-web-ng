...
@Component({
  selector: 'app-eft-analysis',
  templateUrl: './eft-analysis.component.html',
  styleUrls: ['./eft-analysis.component.scss'],
})
export class EFTAnalysisComponent implements OnInit {
