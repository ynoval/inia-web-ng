...
@Component({
  selector: 'app-zone-area-info',
  templateUrl: './zone-area-distribution.component.html',
  styleUrls: ['./zone-area-distribution.component.scss'],
})
export class ZoneAreaDistributionComponent implements OnInit {
