...
@Component({
  selector: 'app-basin-ppna-annual-chart',
  templateUrl: './basin-ppna-annual-chart.component.html',
  styleUrls: ['./basin-ppna-annual-chart.component.scss'],
})
export class BasinPPNAAnnualChartComponent {
