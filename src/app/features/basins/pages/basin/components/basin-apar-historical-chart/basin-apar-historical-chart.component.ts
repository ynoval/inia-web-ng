...
@Component({
  selector: 'app-basin-apar-historical-chart',
  templateUrl: './basin-apar-historical-chart.component.html',
  styleUrls: ['./basin-apar-historical-chart.component.scss'],
})
export class BasinAPARHistoricalChartComponent {
