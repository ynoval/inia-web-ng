...
@Component({
  selector: 'app-basin-ahppn-analysis',
  templateUrl: './basin-ahppn-analysis.component.html',
  styleUrls: ['./basin-ahppn-analysis.component.scss'],
})
export class BasinAHPPNAnalysisComponent implements OnInit {
