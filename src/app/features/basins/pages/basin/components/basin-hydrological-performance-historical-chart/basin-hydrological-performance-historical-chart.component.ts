...
@Component({
  selector: 'app-basin-rh-historical-chart',
  templateUrl: './basin-hydrological-performance-historical-chart.component.html',
  styleUrls: ['./basin-hydrological-performance-historical-chart.component.scss'],
})
export class BasinHydrologicalPerformanceHistoricalChartComponent {
