...
@Component({
  selector: 'app-basin-soil-analysis',
  templateUrl: './basin-soil-analysis.component.html',
  styleUrls: ['./basin-soil-analysis.component.scss'],
})
export class BasinSOILAnalysisComponent implements OnInit {
