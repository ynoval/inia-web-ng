...
@Component({
  selector: 'app-basin-ppna-historical-chart',
  templateUrl: './basin-ppna-historical-chart.component.html',
  styleUrls: ['./basin-ppna-historical-chart.component.scss'],
})
export class BasinPPNAHistoricalChartComponent {
