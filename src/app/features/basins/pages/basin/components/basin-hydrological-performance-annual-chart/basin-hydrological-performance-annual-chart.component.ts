...
@Component({
  selector: 'app-basin-rh-annual-chart',
  templateUrl: './basin-hydrological-performance-annual-chart.component.html',
  styleUrls: ['./basin-hydrological-performance-annual-chart.component.scss'],
})
export class BasinHydrologicalPerformanceAnnualChartComponent {
